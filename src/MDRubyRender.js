...
MDRubyRender.render = function (text, options) {
    return handleEscapedSpecialBrackets(addFurigana(text, options || MDRubyRender.DEFAULT_OPTIONS))
}
MDRubyRender.registerMarked = function (renderer) {
    renderer.text = function (text) {
        // console.log('override text render',text);
        // console.log('after add',addFurigana(text, options));
        return MDRubyRender.render(text)
    }
}

MDRubyRender.registerMarkit = function (helper) {
